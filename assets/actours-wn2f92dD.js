...
function y(n, e) {
	const t = ne(n, ce.__wbindgen_malloc), r = se, _ = ne(e, ce.__wbindgen_malloc), i = se, o = ce.detectDetach(t, r, _, i);
	if (o[3]) throw te(o[2]);
	...
	return {
		...
		"./actours_bg.js": {
			...
			__wbg___wbindgen_debug_string_ab4b34d23d6778bd: function(n, e) {
				const t = ee(En(e), ce.__wbindgen_malloc, ce.__wbindgen_realloc), r = se;
				Xn().setInt32(n + 4, r, !0), Xn().setInt32(n + 0, t, !0);
			},
			...
			__wbg_new_from_slice_3115b094b1002246: function(n, e) {
				return new Float64Array(Gn(n, e));
			},
...
async function ue(n) {
	if (void 0 !== ce) return ce;
	void 0 !== n && (Object.getPrototypeOf(n) === Object.prototype ? {module_or_path: n} = n : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), void 0 === n && (n = new URL("/sleep-scoring-wasm/assets/actours_bg-uEPV74Qr.wasm", "" + import.meta.url));
	const e = Dn();
