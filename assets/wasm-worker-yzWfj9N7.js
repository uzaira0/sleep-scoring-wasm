...
function x(e) {
	...
	return {
		...n,
		disposition: r,
		observed: "observed" in t ? U(t.observed, !0) : n,
		applied: "applied" in t ? U(t.applied, !0) : n
	};
}
const W = 1073741824, _ = "actours.compute.v1", R = "actours-corrected-3.3.7-v2";
function k(e) {
...
"undefined" != typeof self && "undefined" == typeof window && (function() {
	...
	async neishabouriCounts(e, t, r, n, a) {
		const o = (await D()).neishabouriCounts(e, t, r, n, a), s = "object" == typeof o && null !== o ? o : null, i = s ? j(s.x) : null, c = s ? j(s.y) : null, u = s ? j(s.z) : null, l = s ? j(s.vm) : null;
	...
	async zeroCrossingCounts(e, t, r, n, a) {
		const o = (await D()).zeroCrossingCounts(e, t, r, n, a), s = "object" == typeof o && null !== o ? o : null, i = s ? j(s.zcx) : null, c = s ? j(s.zcy) : null, u = s ? j(s.zcz) : null;
	...
	async computeMimsUnit(e, t, r, n, a = {}) {
		...
		const s = $(o.computeMimsUnit(e, t, r, n, a), "computeMimsUnit");
		return g(s, [
			s.mimsUnit.buffer,
			s.mimsUnitX?.buffer,
			s.mimsUnitY?.buffer,
	...
	async computeMimsUnitDataframe(e, t, r, n, a = {}) {
		...
		const s = $(o.computeMimsUnitDataframe(e, t, r, n, a), "computeMimsUnitDataframe");
		return g(s, [
			s.mimsUnit.buffer,
			s.mimsUnitX?.buffer,
			s.mimsUnitY?.buffer,
	...
	async epochWithBandpass(e, t, r) {
		const n = (await D()).epochWithBandpass(e, t, r), a = "object" == typeof n && null !== n ? n : null, o = j(a?.timestamps), s = j(a?.counts);
	...
	async processRawXyz(e, t, r, n, a, o) {
		const s = (await D()).processRawXyz(e, t, r, n, a, o ?? void 0), i = "object" == typeof s && null !== s ? s : null, c = i ? j(i.enmo5s) : null, u = i ? j(i.anglez5s) : null, l = i ? j(i.countsX) : null, f = i ? j(i.countsY) : null, p = i ? j(i.countsZ) : null, m = i ? j(i.countsVm) : null;
		if (!(c && u && l && f && p && m)) throw new Error(`processRawXyz: unexpected WASM return shape — got ${JSON.stringify(s)}`);
		const y = (e) => j(e) ?? /* @__PURE__ */ new Float64Array(0), d = i ? y(i.anglex5s) : /* @__PURE__ */ new Float64Array(0), w = i ? y(i.angley5s) : /* @__PURE__ */ new Float64Array(0), b = i ? y(i.mad5s) : /* @__PURE__ */ new Float64Array(0), h = i ? y(i.enmoa5s) : /* @__PURE__ */ new Float64Array(0);
		return g({
			enmo5s: c,
			anglez5s: u,
			anglex5s: d,
	...
	async processRawXyzImputed(e, t, r, n, a, o, s = 60) {
		const i = await D(), c = "function" == typeof i.processRawXyzImputedWithEpoch ? i.processRawXyzImputedWithEpoch(e, t, r, n, a, o ?? void 0, s) : i.processRawXyzImputed(e, t, r, n, a, o ?? void 0), u = "object" == typeof c && null !== c ? c : null, l = u ? j(u.enmo5s) : null, f = u ? j(u.anglez5s) : null, p = u ? j(u.countsX) : null, m = u ? j(u.countsY) : null, y = u ? j(u.countsZ) : null, d = u ? j(u.countsVm) : null;
		if (!(l && f && p && m && y && d)) throw new Error(`processRawXyzImputed: unexpected WASM return shape — got ${JSON.stringify(c)}`);
		const w = (e) => j(e) ?? /* @__PURE__ */ new Float64Array(0), b = u ? w(u.anglex5s) : /* @__PURE__ */ new Float64Array(0), h = u ? w(u.angley5s) : /* @__PURE__ */ new Float64Array(0), A = u ? w(u.mad5s) : /* @__PURE__ */ new Float64Array(0), S = u ? w(u.enmoa5s) : /* @__PURE__ */ new Float64Array(0);
		return g({
			enmo5s: l,
			anglez5s: f,
			anglex5s: b,
	...
	getComputeIdentity: async () => function(e, t) {
		...
		if (!(Array.isArray(r.semanticProfiles) ? r.semanticProfiles : []).includes(R)) throw new Error(`Actours capability does not provide required semantic profile ${R}`);
	...
	async readGgirMeta(e) {
		...
		const r = t.readGgirMeta(e), n = "object" == typeof r && null !== r ? r : null, a = n ? j(n.timestampsMs) : null, o = n ? j(n.enmo5s) : null, s = n ? j(n.anglez5s) : null, i = n ? G(n.invalidShort) : null, c = n ? G(n.nonwearShort) : null;
	...
	async detectGgirHasptVariant(e) {
		const t = function(e, t) {
			...
			const r = e, n = G(r.nomov), a = j(r.rollingMedian);
