...
*/
const e = Symbol("Comlink.proxy"), t = Symbol("Comlink.endpoint"), n = Symbol("Comlink.releaseProxy"), r = Symbol("Comlink.finalizer"), s = Symbol("Comlink.thrown"), a = (e) => "object" == typeof e && null !== e || "function" == typeof e, o = /* @__PURE__ */ new Map([["proxy", {
	canHandle: (t) => a(t) && t[e],
	serialize(e) {
...
function R() {
	return F || (F = (async () => {
		const e = await import("./actours-D-zjfIeN.js");
...
(function() {
	...
	async processGt3xFull(e, t = 60) {
		const n = await R(), r = "function" == typeof n.processGt3xPart1WithEpoch ? () => n.processGt3xPart1WithEpoch(new Uint8Array(e), t) : "function" == typeof n.processGt3xPart1 ? () => n.processGt3xPart1(new Uint8Array(e)) : null, s = r ? r() : "function" == typeof n.processGt3xFullWithEpoch ? n.processGt3xFullWithEpoch(new Uint8Array(e), t) : n.processGt3xFull(new Uint8Array(e)), a = (e) => e instanceof Float64Array ? e : new Float64Array(e), o = (e) => e ? a(e) : /* @__PURE__ */ new Float64Array(0), i = a(s.enmo5s), c = a(s.anglez5s), u = o(s.anglex5s), l = o(s.angley5s), f = o(s.mad5s), p = o(s.enmoa5s), m = a(s.countsX), d = a(s.countsY), y = a(s.countsZ), b = a(s.countsVm), h = o(s.zcx60s), w = o(s.zcy60s), E = o(s.zcz60s), v = o(s.mimsUnit), A = o(s.mimsUnitX), x = o(s.mimsUnitY), M = o(s.mimsUnitZ), S = (k = s.preschoolWristRfClasses) instanceof Uint8Array ? k : k ? new Uint8Array(k) : /* @__PURE__ */ new Uint8Array(0);
		var k;
		const F = ((e) => e instanceof Float32Array ? e : e ? new Float32Array(e) : /* @__PURE__ */ new Float32Array(0))(s.lstmFeatures30s);
		return g({
			enmo5s: i,
			anglez5s: c,
			anglex5s: u,
