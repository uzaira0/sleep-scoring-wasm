...
function m(n, e, t, _, r, i, o, c, a, l, s, u, w, g, b, f, d, m, h) {
	const p = de(n, ke.__wbindgen_malloc, ke.__wbindgen_realloc), y = Ae, v = fe(e, ke.__wbindgen_malloc), k = Ae, A = ge(t, ke.__wbindgen_malloc), x = Ae, C = fe(_, ke.__wbindgen_malloc), R = Ae, S = ge(r, ke.__wbindgen_malloc), F = Ae, M = be(i, ke.__wbindgen_malloc), P = Ae, U = ge(o, ke.__wbindgen_malloc), D = Ae, I = be(c, ke.__wbindgen_malloc), z = Ae, B = ge(a, ke.__wbindgen_malloc), O = Ae, W = fe(l, ke.__wbindgen_malloc), N = Ae, j = ge(s, ke.__wbindgen_malloc), E = Ae, G = fe(u, ke.__wbindgen_malloc), T = Ae, V = ge(w, ke.__wbindgen_malloc), L = Ae, X = fe(g, ke.__wbindgen_malloc), q = Ae, H = ge(b, ke.__wbindgen_malloc), $ = Ae, Y = fe(f, ke.__wbindgen_malloc), Z = Ae, K = ge(d, ke.__wbindgen_malloc), J = Ae, Q = be(m, ke.__wbindgen_malloc), nn = Ae, en = ge(h, ke.__wbindgen_malloc), tn = Ae, _n = ke.computeNightDifficultyTyped(p, y, v, k, A, x, C, R, S, F, M, P, U, D, I, z, B, O, W, N, j, E, G, T, V, L, X, q, H, $, Y, Z, K, J, Q, nn, en, tn);
...
function p(n, e, t, _, r, i, o, c, a, l, s, u, w, g, b, f, d, m, h) {
	const p = de(n, ke.__wbindgen_malloc, ke.__wbindgen_realloc), y = Ae, v = fe(e, ke.__wbindgen_malloc), k = Ae, A = ge(t, ke.__wbindgen_malloc), x = Ae, C = fe(_, ke.__wbindgen_malloc), R = Ae, S = ge(r, ke.__wbindgen_malloc), F = Ae, M = be(i, ke.__wbindgen_malloc), P = Ae, U = ge(o, ke.__wbindgen_malloc), D = Ae, I = be(c, ke.__wbindgen_malloc), z = Ae, B = ge(a, ke.__wbindgen_malloc), O = Ae, W = fe(l, ke.__wbindgen_malloc), N = Ae, j = ge(s, ke.__wbindgen_malloc), E = Ae, G = fe(u, ke.__wbindgen_malloc), T = Ae, V = ge(w, ke.__wbindgen_malloc), L = Ae, X = fe(g, ke.__wbindgen_malloc), q = Ae, H = ge(b, ke.__wbindgen_malloc), $ = Ae, Y = fe(f, ke.__wbindgen_malloc), Z = Ae, K = ge(d, ke.__wbindgen_malloc), J = Ae, Q = be(m, ke.__wbindgen_malloc), nn = Ae, en = ge(h, ke.__wbindgen_malloc), tn = Ae, _n = ke.computeNightSignalsTyped(p, y, v, k, A, x, C, R, S, F, M, P, U, D, I, z, B, O, W, N, j, E, G, T, V, L, X, q, H, $, Y, Z, K, J, Q, nn, en, tn);
	if (_n[2]) throw me(_n[1]);
	return me(_n[0]);
}
function y(n, e, t) {
...
function tn(n, e, t, _, r, i, o, c, a, l, s, u, w, g, b, f, d, m, h) {
	const p = de(n, ke.__wbindgen_malloc, ke.__wbindgen_realloc), y = Ae, v = fe(e, ke.__wbindgen_malloc), k = Ae, A = ge(t, ke.__wbindgen_malloc), x = Ae, C = fe(_, ke.__wbindgen_malloc), R = Ae, S = ge(r, ke.__wbindgen_malloc), F = Ae, M = be(i, ke.__wbindgen_malloc), P = Ae, U = ge(o, ke.__wbindgen_malloc), D = Ae, I = be(c, ke.__wbindgen_malloc), z = Ae, B = ge(a, ke.__wbindgen_malloc), O = Ae, W = fe(l, ke.__wbindgen_malloc), N = Ae, j = ge(s, ke.__wbindgen_malloc), E = Ae, G = fe(u, ke.__wbindgen_malloc), T = Ae, V = ge(w, ke.__wbindgen_malloc), L = Ae, X = fe(g, ke.__wbindgen_malloc), q = Ae, H = ge(b, ke.__wbindgen_malloc), $ = Ae, Y = fe(f, ke.__wbindgen_malloc), Z = Ae, K = ge(d, ke.__wbindgen_malloc), J = Ae, Q = be(m, ke.__wbindgen_malloc), nn = Ae, en = ge(h, ke.__wbindgen_malloc), tn = Ae, _n = ke.placeMarkersTyped(p, y, v, k, A, x, C, R, S, F, M, P, U, D, I, z, B, O, W, N, j, E, G, T, V, L, X, q, H, $, Y, Z, K, J, Q, nn, en, tn);
	if (_n[2]) throw me(_n[1]);
	return me(_n[0]);
}
function _n(n) {
...
async function Re(n) {
	if (void 0 !== ke) return ke;
	void 0 !== n && (Object.getPrototypeOf(n) === Object.prototype ? {module_or_path: n} = n : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), void 0 === n && (n = new URL("/sleep-scoring-wasm/assets/actours_bg-DPhpOfU9.wasm", "" + import.meta.url));
	const e = $n();
