...
const B = O.filter((e) => "sleep_wake" === e.kind).map((e) => ({
	id: e.id,
	displayGrid: e.displayGrid,
	execution: e.execution,
	requiredSignal: e.requiredSignal,
	family: e.family
})), L = new Map(B.map((e) => [e.id, e]));
function H(e) {
	if (!e) return !1;
	const n = L.get(e);
...
async function oe() {
	const e = await async function(e) {
		...
		loadThreaded: () => import("./actours-Gqi_OMp9.js"),
		loadSingle: () => import("./actours-CJzkkP7t.js"),
		warn: (e, n) => {
			console.warn(e, n);
		}
	});
...
function Ce(e, n, t, r) {
	...
	try {
		...
		for (const t of n) o[t] = Ie(e.results.find((e) => e.algorithm === t), a);
	} catch {
...
"undefined" != typeof self && "undefined" == typeof window && (function() {
	...
	async detectNonwearUnified(e) {
		const n = function(e, n) {
			return Ce(e, [n.algorithm], n.signals, n.config)[n.algorithm];
		}(await be(), e);
		return _(n, n.nonwear ? [n.nonwear.buffer] : []);
	},
	async detectNonwearUnifiedBatch(e, n) {
		const t = Ce(await be(), e, n);
	...
	}((await be()).getComputeCapabilitiesV1(), "15ceb921de3750105d48ff88611197eb3d7226a23df5dd77493c07cb0d5d427f"),
