...
const v = "smart", S = "webster", M = {
	...
	none: "none"
}, E = M.diary, N = M.hdcza, k = M.l5, C = M.selected_scorer_first_last, F = M.selected_scorer_longest_bout, P = M.quiet_bout, x = M.none, O = "use_source_a", R = {
	sourceA: "hdcza",
...
var $ = n({
	...
	detectNonwearUnifiedBatchTyped: () => Ee,
	epochRawData: () => Ne,
	epochWithBandpass: () => ke,
	executeHeroRuntime: () => Ce,
	extractCapsense: () => Fe,
	getComputeCapabilitiesV1: () => Pe,
	initSync: () => ut,
	installPanicHook: () => xe,
	isGeneactivFormat: () => Oe,
	lstmSpectralFeatures30s: () => Re,
	neishabouriCounts: () => Ue,
	parseActigraphCsv: () => We,
	parseActigraphCsvBuffered: () => Ge,
	parseCwa: () => ze,
	parseEpochSeries: () => De,
	parseGeneactivBin: () => Te,
	parseGeneactivCsv: () => Be,
	parseGeneactivCsvBuffered: () => je,
	parseGt3x: () => Ie,
	placeMarkers: () => Ve,
	placeMarkersBatch: () => Le,
	placeNonwearMarkers: () => $e,
	prepareCompactPipelineOutcomeV1: () => He,
	prepareCompactPipelineV1: () => Je,
	processGeneactivRaw: () => Xe,
	processGt3xFull: () => Ye,
	processGt3xFullWithEpoch: () => Ze,
	processGt3xPart1: () => qe,
	processGt3xPart1WithEpoch: () => Ke,
	processRawXyz: () => Qe,
	processRawXyzImputed: () => en,
	processRawXyzImputedWithEpoch: () => nn,
	readGgirMeta: () => tn,
	recommended_chunk_size_mb: () => rn,
	reduceF64V1: () => on,
	runCompactPipelineOutcomeV1: () => an,
	runCompactPipelineV1: () => sn,
	runFullPipeline: () => cn,
	runFullPipelineOutcomeV1: () => un,
	runFullPipelineV1: () => ln,
	runGgirFromEpoch: () => _n,
	runMilestone: () => fn,
	scoreAllDays: () => dn,
	scoreColeKripke: () => pn,
	scoreConsensus: () => gn,
	scoreConsensusMajority: () => mn,
	scoreEpochs: () => wn,
	scoreEpochsTyped: () => bn,
	scoreGgirHasib: () => yn,
	...
	sha256StreamStart: () => En,
	streamParseFeed: () => Nn,
	streamParseFinish: () => kn,
	streamParseFinishChunk: () => Cn,
	streamParseStart: () => Fn,
	streamParseStartData: () => Pn,
	streamParseStartWithEpoch: () => xn,
	...
	get canonicalPassReason() {
		...
		let n;
		return 0 !== e[0] && (n = Hn(e[0], e[1]).slice(), at.__wbindgen_free(e[0], 1 * e[1], 1)), n;
	}
	get counts() {
...
function Ee(e, n, t, r, o, i, a) {
	const s = et(e, at.__wbindgen_malloc, at.__wbindgen_realloc), c = st, u = et(n, at.__wbindgen_malloc, at.__wbindgen_realloc), l = st, _ = Qn(t, at.__wbindgen_malloc), f = st, d = Qn(r, at.__wbindgen_malloc), p = st, g = Qn(o, at.__wbindgen_malloc), m = st, w = at.detectNonwearUnifiedBatchTyped(s, c, u, l, _, f, d, p, g, m, i, a);
	if (w[2]) throw nt(w[1]);
	return nt(w[0]);
}
...
function Le(e, n, t, r, o, i) {
	const a = et(e, at.__wbindgen_malloc, at.__wbindgen_realloc), s = st, c = Qn(n, at.__wbindgen_malloc), u = st, l = Qn(t, at.__wbindgen_malloc), _ = st, f = Kn(r, at.__wbindgen_malloc), d = st, p = Kn(o, at.__wbindgen_malloc), g = st, m = et(i, at.__wbindgen_malloc, at.__wbindgen_realloc), w = st, b = at.placeMarkersBatch(a, s, c, u, l, _, f, d, p, g, m, w);
	if (b[2]) throw nt(b[1]);
	return nt(b[0]);
}
function $e(e) {
...
function bn(e, n, t, r, o, i) {
	const a = et(e, at.__wbindgen_malloc, at.__wbindgen_realloc), s = st, c = Qn(n, at.__wbindgen_malloc), u = st, l = Qn(t, at.__wbindgen_malloc), _ = st, f = Qn(r, at.__wbindgen_malloc), d = st, p = at.scoreEpochsTyped(a, s, c, u, l, _, f, d, o, i);
	if (p[2]) throw nt(p[1]);
	return nt(p[0]);
}
function yn(e) {
...
function Bn(e, n) {
	return e >>>= 0, (null !== Jn && 0 !== Jn.byteLength || (Jn = new Uint32Array(at.memory.buffer)), Jn).subarray(e / 4, e / 4 + n);
}
function jn(e, n) {
...
let at, st = 0;
function ct(e, n) {
	return at = e.exports, In = null, Ln = null, Jn = null, Xn = null, at.__wbindgen_start(), at;
}
function ut(e) {
...
async function lt(e) {
	if (void 0 !== at) return at;
	void 0 !== e && (Object.getPrototypeOf(e) === Object.prototype ? {module_or_path: e} = e : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), void 0 === e && (e = new URL("/sleep-scoring-wasm/assets/actours_bg-BBlhctE3.wasm", "" + import.meta.url));
	const n = Un();
...
function Dt(e, n, t, r) {
	...
	try {
		...
		for (const t of n) i[t] = zt(e.results.find((e) => e.algorithm === t), o);
	} catch {
...
"undefined" != typeof self && "undefined" == typeof window && (function() {
	...
	async detectNonwearUnified(e) {
		const n = function(e, n) {
			return Dt(e, [n.algorithm], n.signals, n.config)[n.algorithm];
		}(await Ct(), e);
		return b(n, n.nonwear ? [n.nonwear.buffer] : []);
	},
	async detectNonwearUnifiedBatch(e, n) {
		const t = Dt(await Ct(), e, n);
	...
	parseActigraphCsv: async (e, n) => Ot((await Ct()).parseActigraphCsv(e, n), "parseActigraphCsv"),
	parseGeneactivCsv: async (e) => Ot((await Ct()).parseGeneactivCsv(e), "parseGeneactivCsv"),
	...
	parseGeneactivCsvBuffered: async () => Ot((await Ct()).parseGeneactivCsvBuffered(), "parseGeneactivCsvBuffered"),
	parseActigraphCsvBuffered: async (e) => Ot((await Ct()).parseActigraphCsvBuffered(e), "parseActigraphCsvBuffered"),
	async sha256Start() {
		await Ct(), En();
	},
	async sha256Feed(e) {
	...
	async streamParseFinishChunk() {
		...
		const n = new Float64Array(e.timestampsMs), t = new Float64Array(e.axisX), r = new Float64Array(e.axisY), o = new Float64Array(e.axisZ), i = new Float64Array(e.vectorMagnitude), a = new Float64Array(e.temperature), s = new Uint32Array(e.counts), c = new Uint32Array(e.tempCounts), u = new Float64Array(e.timestampsMs5s), l = new Float64Array(e.enmo5s), _ = new Float64Array(e.anglez5s), f = new Float64Array(e.anglex5s ?? 0), d = new Float64Array(e.angley5s ?? 0), p = new Float64Array(e.mad5s ?? 0), g = new Float64Array(e.enmoa5s ?? 0), m = e, w = new Float64Array(m.zcx60s ?? []), y = new Float64Array(m.zcy60s ?? []), h = new Float64Array(m.zcz60s ?? []), A = new Uint32Array(e.counts5s), v = e, S = new Float64Array(v.mimsUnit ?? []), M = new Float64Array(v.mimsUnitX ?? []), E = new Float64Array(v.mimsUnitY ?? []), N = new Float64Array(v.mimsUnitZ ?? []), k = e;
		return b({
			timestampsMs: n,
			axisX: t,
			axisY: r,
	...
	async neishabouriCounts(e, n, t, r, o) {
		const i = (await Ct()).neishabouriCounts(e, n, t, r, o), a = "object" == typeof i && null !== i ? i : null, s = a ? Pt(a.x) : null, c = a ? Pt(a.y) : null, u = a ? Pt(a.z) : null, l = a ? Pt(a.vm) : null;
	...
	async zeroCrossingCounts(e, n, t, r, o) {
		const i = (await Ct()).zeroCrossingCounts(e, n, t, r, o), a = "object" == typeof i && null !== i ? i : null, s = a ? Pt(a.zcx) : null, c = a ? Pt(a.zcy) : null, u = a ? Pt(a.zcz) : null;
	...
	async classifyActimetricPreschoolWristRf(e, n, t, r) {
		...
		const a = function(e, n = "classifyActimetricPreschoolWristRf") {
			...
			const r = "object" == typeof e && null !== e ? e : null, o = r ? xt(r.classes) ?? xt(r.activityClasses) ?? xt(r.predictions) ?? xt(r.activity) : null;
	...
	epochRawData: async (e, n, t, r, o) => Ot((await Ct()).epochRawData(e, n, t, r, o), "epochRawData"),
	async epochWithBandpass(e, n, t) {
		const r = (await Ct()).epochWithBandpass(e, n, t), o = "object" == typeof r && null !== r ? r : null, i = Pt(o?.timestamps), a = Pt(o?.counts);
	...
	async processRawXyz(e, n, t, r, o, i) {
		const a = (await Ct()).processRawXyz(e, n, t, r, o, i ?? void 0), s = "object" == typeof a && null !== a ? a : null, c = s ? Pt(s.enmo5s) : null, u = s ? Pt(s.anglez5s) : null, l = s ? Pt(s.countsX) : null, _ = s ? Pt(s.countsY) : null, f = s ? Pt(s.countsZ) : null, d = s ? Pt(s.countsVm) : null;
		if (!(c && u && l && _ && f && d)) throw new Error(`processRawXyz: unexpected WASM return shape — got ${JSON.stringify(a)}`);
		const p = (e) => Pt(e) ?? /* @__PURE__ */ new Float64Array(0), g = s ? p(s.anglex5s) : /* @__PURE__ */ new Float64Array(0), m = s ? p(s.angley5s) : /* @__PURE__ */ new Float64Array(0), w = s ? p(s.mad5s) : /* @__PURE__ */ new Float64Array(0), y = s ? p(s.enmoa5s) : /* @__PURE__ */ new Float64Array(0);
		return b({
			enmo5s: c,
			anglez5s: u,
			anglex5s: g,
	...
	async processRawXyzImputed(e, n, t, r, o, i, a = 60) {
		const s = await Ct(), c = "function" == typeof s.processRawXyzImputedWithEpoch ? s.processRawXyzImputedWithEpoch(e, n, t, r, o, i ?? void 0, a) : s.processRawXyzImputed(e, n, t, r, o, i ?? void 0), u = "object" == typeof c && null !== c ? c : null, l = u ? Pt(u.enmo5s) : null, _ = u ? Pt(u.anglez5s) : null, f = u ? Pt(u.countsX) : null, d = u ? Pt(u.countsY) : null, p = u ? Pt(u.countsZ) : null, g = u ? Pt(u.countsVm) : null;
		if (!(l && _ && f && d && p && g)) throw new Error(`processRawXyzImputed: unexpected WASM return shape — got ${JSON.stringify(c)}`);
		const m = (e) => Pt(e) ?? /* @__PURE__ */ new Float64Array(0), w = u ? m(u.anglex5s) : /* @__PURE__ */ new Float64Array(0), y = u ? m(u.angley5s) : /* @__PURE__ */ new Float64Array(0), h = u ? m(u.mad5s) : /* @__PURE__ */ new Float64Array(0), A = u ? m(u.enmoa5s) : /* @__PURE__ */ new Float64Array(0);
		return b({
			enmo5s: l,
			anglez5s: _,
			anglex5s: w,
		...
		return a ? {
			result: (s = a.result, {
				...
				days: s.days.map((e) => ({
					...
					tstMinutes: Et(e.tstMinutes),
					wasoMinutes: Et(e.wasoMinutes),
					sleepEfficiency: Et(e.sleepEfficiency),
					numberOfAwakenings: e.numberOfAwakenings,
					sptDurationHours: Et(e.sptDurationHours),
	...
	}((await Ct()).getComputeCapabilitiesV1(), "366df03a5141f9c5005610ed209352b25c0f807bd3af3bb3ac1ee377fe34378b"),
	...
	async readGgirMeta(e) {
		...
		const t = n.readGgirMeta(e), r = "object" == typeof t && null !== t ? t : null, o = r ? Pt(r.timestampsMs) : null, i = r ? Pt(r.enmo5s) : null, a = r ? Pt(r.anglez5s) : null, s = r ? Pt(r.anglex5s) : null, c = r ? Pt(r.angley5s) : null, u = r ? xt(r.invalidShort) : null, l = r ? xt(r.nonwearShort) : null;
	...
	async detectGgirHasptVariant(e) {
		const n = function(e, n) {
			...
			const t = e, r = xt(t.nomov), o = Pt(t.rollingMedian);
