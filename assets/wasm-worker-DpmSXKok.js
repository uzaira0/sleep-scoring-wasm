...
var $ = n({
	...
	parseGt3x: () => $e,
	placeMarkers: () => He,
	placeMarkersBatch: () => Je,
	placeMarkersTyped: () => Xe,
...
function le(e, n, t, r, o, i, a, s, c, l, u, _, f, d, g, p, m, w, b) {
	const y = ct(e, gt.__wbindgen_malloc, gt.__wbindgen_realloc), h = pt, A = st(n, gt.__wbindgen_malloc), v = pt, S = it(t, gt.__wbindgen_malloc), M = pt, E = st(r, gt.__wbindgen_malloc), k = pt, N = it(o, gt.__wbindgen_malloc), C = pt, F = at(i, gt.__wbindgen_malloc), P = pt, x = it(a, gt.__wbindgen_malloc), O = pt, U = at(s, gt.__wbindgen_malloc), R = pt, T = it(c, gt.__wbindgen_malloc), W = pt, G = st(l, gt.__wbindgen_malloc), z = pt, D = it(u, gt.__wbindgen_malloc), B = pt, j = st(_, gt.__wbindgen_malloc), I = pt, V = it(f, gt.__wbindgen_malloc), L = pt, $ = st(d, gt.__wbindgen_malloc), H = pt, J = it(g, gt.__wbindgen_malloc), X = pt, Y = st(p, gt.__wbindgen_malloc), Z = pt, q = it(m, gt.__wbindgen_malloc), K = pt, Q = at(w, gt.__wbindgen_malloc), ee = pt, ne = it(b, gt.__wbindgen_malloc), te = pt, re = gt.computeNightDifficultyTyped(y, h, A, v, S, M, E, k, N, C, F, P, x, O, U, R, T, W, G, z, D, B, j, I, V, L, $, H, J, X, Y, Z, q, K, Q, ee, ne, te);
...
function _e(e, n, t, r, o, i, a, s, c, l, u, _, f, d, g, p, m, w, b) {
	const y = ct(e, gt.__wbindgen_malloc, gt.__wbindgen_realloc), h = pt, A = st(n, gt.__wbindgen_malloc), v = pt, S = it(t, gt.__wbindgen_malloc), M = pt, E = st(r, gt.__wbindgen_malloc), k = pt, N = it(o, gt.__wbindgen_malloc), C = pt, F = at(i, gt.__wbindgen_malloc), P = pt, x = it(a, gt.__wbindgen_malloc), O = pt, U = at(s, gt.__wbindgen_malloc), R = pt, T = it(c, gt.__wbindgen_malloc), W = pt, G = st(l, gt.__wbindgen_malloc), z = pt, D = it(u, gt.__wbindgen_malloc), B = pt, j = st(_, gt.__wbindgen_malloc), I = pt, V = it(f, gt.__wbindgen_malloc), L = pt, $ = st(d, gt.__wbindgen_malloc), H = pt, J = it(g, gt.__wbindgen_malloc), X = pt, Y = st(p, gt.__wbindgen_malloc), Z = pt, q = it(m, gt.__wbindgen_malloc), K = pt, Q = at(w, gt.__wbindgen_malloc), ee = pt, ne = it(b, gt.__wbindgen_malloc), te = pt, re = gt.computeNightSignalsTyped(y, h, A, v, S, M, E, k, N, C, F, P, x, O, U, R, T, W, G, z, D, B, j, I, V, L, $, H, J, X, Y, Z, q, K, Q, ee, ne, te);
	if (re[2]) throw lt(re[1]);
	return lt(re[0]);
}
function fe(e, n, t) {
...
function Xe(e, n, t, r, o, i, a, s, c, l, u, _, f, d, g, p, m, w, b) {
	const y = ct(e, gt.__wbindgen_malloc, gt.__wbindgen_realloc), h = pt, A = st(n, gt.__wbindgen_malloc), v = pt, S = it(t, gt.__wbindgen_malloc), M = pt, E = st(r, gt.__wbindgen_malloc), k = pt, N = it(o, gt.__wbindgen_malloc), C = pt, F = at(i, gt.__wbindgen_malloc), P = pt, x = it(a, gt.__wbindgen_malloc), O = pt, U = at(s, gt.__wbindgen_malloc), R = pt, T = it(c, gt.__wbindgen_malloc), W = pt, G = st(l, gt.__wbindgen_malloc), z = pt, D = it(u, gt.__wbindgen_malloc), B = pt, j = st(_, gt.__wbindgen_malloc), I = pt, V = it(f, gt.__wbindgen_malloc), L = pt, $ = st(d, gt.__wbindgen_malloc), H = pt, J = it(g, gt.__wbindgen_malloc), X = pt, Y = st(p, gt.__wbindgen_malloc), Z = pt, q = it(m, gt.__wbindgen_malloc), K = pt, Q = at(w, gt.__wbindgen_malloc), ee = pt, ne = it(b, gt.__wbindgen_malloc), te = pt, re = gt.placeMarkersTyped(y, h, A, v, S, M, E, k, N, C, F, P, x, O, U, R, T, W, G, z, D, B, j, I, V, L, $, H, J, X, Y, Z, q, K, Q, ee, ne, te);
	if (re[2]) throw lt(re[1]);
	return lt(re[0]);
}
function Ye(e) {
...
let Xn = null;
function Yn() {
	return (null === Xn || !0 === Xn.buffer.detached || void 0 === Xn.buffer.detached && Xn.buffer !== gt.memory.buffer) && (Xn = new DataView(gt.memory.buffer)), Xn;
}
let Zn = null;
function qn() {
...
let gt, pt = 0;
function mt(e, n) {
	return gt = e.exports, Xn = null, Zn = null, Qn = null, nt = null, gt.__wbindgen_start(), gt;
}
function wt(e) {
...
async function bt(e) {
	if (void 0 !== gt) return gt;
	void 0 !== e && (Object.getPrototypeOf(e) === Object.prototype ? {module_or_path: e} = e : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), void 0 === e && (e = new URL("/sleep-scoring-wasm/assets/actours_bg-4KRwDckJ.wasm", "" + import.meta.url));
	const n = Bn();
...
"undefined" != typeof self && "undefined" == typeof window && (function() {
	...
	}((await Wt()).getComputeCapabilitiesV1(), "448af05126aa331300a45a9e16f80ec2ee36ae66c6d300777c16b2ae78322ce2"),
