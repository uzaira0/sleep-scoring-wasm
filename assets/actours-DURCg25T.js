var n = class n {
	...
	get canonicalPassReason() {
		...
		let e;
		return 0 !== n[0] && (e = $n(n[0], n[1]).slice(), se.__wbindgen_free(n[0], 1 * n[1], 1)), e;
	}
	get counts() {
	...
	return {
		...
		"./actours_bg.js": {
			...
			__wbg___wbindgen_debug_string_ab4b34d23d6778bd: function(n, e) {
				const t = te(En(e), se.__wbindgen_malloc, se.__wbindgen_realloc), r = ae;
				qn().setInt32(n + 4, r, !0), qn().setInt32(n + 0, t, !0);
			},
...
function Vn(n, e) {
	return n >>>= 0, (null !== Yn && 0 !== Yn.byteLength || (Yn = new Uint32Array(se.memory.buffer)), Yn).subarray(n / 4, n / 4 + e);
}
function Ln(n, e) {
...
let se, ae = 0;
function le(n, e) {
	return se = n.exports, Xn = null, Tn = null, Yn = null, Zn = null, se.__wbindgen_start(), se;
}
function ue(n) {
...
async function fe(n) {
	if (void 0 !== se) return se;
	void 0 !== n && (Object.getPrototypeOf(n) === Object.prototype ? {module_or_path: n} = n : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), void 0 === n && (n = new URL("/sleep-scoring-wasm/assets/actours_bg-CblvgW3I.wasm", "" + import.meta.url));
	const e = On();
