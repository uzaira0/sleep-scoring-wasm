...
function h(n, e, t, _, r, i, o, c, a, l, s, u, w, g, b, f, d, m, h) {
	const p = ve(n, Re.__wbindgen_malloc, Re.__wbindgen_realloc), y = Fe, v = ye(e, Re.__wbindgen_malloc), k = Fe, A = he(t, Re.__wbindgen_malloc), x = Fe, C = ye(_, Re.__wbindgen_malloc), S = Fe, R = he(r, Re.__wbindgen_malloc), F = Fe, P = pe(i, Re.__wbindgen_malloc), M = Fe, U = he(o, Re.__wbindgen_malloc), I = Fe, W = pe(c, Re.__wbindgen_malloc), z = Fe, B = he(a, Re.__wbindgen_malloc), D = Fe, O = ye(l, Re.__wbindgen_malloc), N = Fe, j = he(s, Re.__wbindgen_malloc), E = Fe, G = ye(u, Re.__wbindgen_malloc), T = Fe, V = he(w, Re.__wbindgen_malloc), L = Fe, X = ye(g, Re.__wbindgen_malloc), q = Fe, H = he(b, Re.__wbindgen_malloc), $ = Fe, Y = ye(f, Re.__wbindgen_malloc), Z = Fe, K = he(d, Re.__wbindgen_malloc), J = Fe, Q = pe(m, Re.__wbindgen_malloc), nn = Fe, en = he(h, Re.__wbindgen_malloc), tn = Fe, _n = Re.computeNightDifficultyTyped(p, y, v, k, A, x, C, S, R, F, P, M, U, I, W, z, B, D, O, N, j, E, G, T, V, L, X, q, H, $, Y, Z, K, J, Q, nn, en, tn);
...
function y(n, e, t, _, r, i, o, c, a, l, s, u, w, g, b, f, d, m, h) {
	const p = ve(n, Re.__wbindgen_malloc, Re.__wbindgen_realloc), y = Fe, v = ye(e, Re.__wbindgen_malloc), k = Fe, A = he(t, Re.__wbindgen_malloc), x = Fe, C = ye(_, Re.__wbindgen_malloc), S = Fe, R = he(r, Re.__wbindgen_malloc), F = Fe, P = pe(i, Re.__wbindgen_malloc), M = Fe, U = he(o, Re.__wbindgen_malloc), I = Fe, W = pe(c, Re.__wbindgen_malloc), z = Fe, B = he(a, Re.__wbindgen_malloc), D = Fe, O = ye(l, Re.__wbindgen_malloc), N = Fe, j = he(s, Re.__wbindgen_malloc), E = Fe, G = ye(u, Re.__wbindgen_malloc), T = Fe, V = he(w, Re.__wbindgen_malloc), L = Fe, X = ye(g, Re.__wbindgen_malloc), q = Fe, H = he(b, Re.__wbindgen_malloc), $ = Fe, Y = ye(f, Re.__wbindgen_malloc), Z = Fe, K = he(d, Re.__wbindgen_malloc), J = Fe, Q = pe(m, Re.__wbindgen_malloc), nn = Fe, en = he(h, Re.__wbindgen_malloc), tn = Fe, _n = Re.computeNightSignalsTyped(p, y, v, k, A, x, C, S, R, F, P, M, U, I, W, z, B, D, O, N, j, E, G, T, V, L, X, q, H, $, Y, Z, K, J, Q, nn, en, tn);
	if (_n[2]) throw ke(_n[1]);
	return ke(_n[0]);
}
function v(n, e, t) {
...
function on(n, e, t, _, r, i, o, c, a, l, s, u, w, g, b, f, d, m, h) {
	const p = ve(n, Re.__wbindgen_malloc, Re.__wbindgen_realloc), y = Fe, v = ye(e, Re.__wbindgen_malloc), k = Fe, A = he(t, Re.__wbindgen_malloc), x = Fe, C = ye(_, Re.__wbindgen_malloc), S = Fe, R = he(r, Re.__wbindgen_malloc), F = Fe, P = pe(i, Re.__wbindgen_malloc), M = Fe, U = he(o, Re.__wbindgen_malloc), I = Fe, W = pe(c, Re.__wbindgen_malloc), z = Fe, B = he(a, Re.__wbindgen_malloc), D = Fe, O = ye(l, Re.__wbindgen_malloc), N = Fe, j = he(s, Re.__wbindgen_malloc), E = Fe, G = ye(u, Re.__wbindgen_malloc), T = Fe, V = he(w, Re.__wbindgen_malloc), L = Fe, X = ye(g, Re.__wbindgen_malloc), q = Fe, H = he(b, Re.__wbindgen_malloc), $ = Fe, Y = ye(f, Re.__wbindgen_malloc), Z = Fe, K = he(d, Re.__wbindgen_malloc), J = Fe, Q = pe(m, Re.__wbindgen_malloc), nn = Fe, en = he(h, Re.__wbindgen_malloc), tn = Fe, _n = Re.placeMarkersTyped(p, y, v, k, A, x, C, S, R, F, P, M, U, I, W, z, B, D, O, N, j, E, G, T, V, L, X, q, H, $, Y, Z, K, J, Q, nn, en, tn);
	if (_n[2]) throw ke(_n[1]);
	return ke(_n[0]);
}
function cn(n) {
...
async function Ue(n) {
	if (void 0 !== Re) return Re;
	void 0 !== n && (Object.getPrototypeOf(n) === Object.prototype ? {module_or_path: n} = n : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), void 0 === n && (n = new URL("/sleep-scoring-wasm/assets/actours_bg-CsEokrxP.wasm", "" + import.meta.url));
	const e = Qn();
