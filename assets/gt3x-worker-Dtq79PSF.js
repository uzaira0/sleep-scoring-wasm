...
(function() {
	...
	async processGt3xFull(e, t = 60) {
		const r = await R(), n = "function" == typeof r.processGt3xPart1WithEpoch ? () => r.processGt3xPart1WithEpoch(new Uint8Array(e), t) : "function" == typeof r.processGt3xPart1 ? () => r.processGt3xPart1(new Uint8Array(e)) : null, a = n ? n() : "function" == typeof r.processGt3xFullWithEpoch ? r.processGt3xFullWithEpoch(new Uint8Array(e), t) : r.processGt3xFull(new Uint8Array(e)), s = (e) => e instanceof Float64Array ? e : new Float64Array(e), o = (e) => e ? s(e) : /* @__PURE__ */ new Float64Array(0), i = (e) => e instanceof Uint8Array ? e : e ? new Uint8Array(e) : /* @__PURE__ */ new Uint8Array(0), c = s(a.enmo5s), u = s(a.anglez5s), l = o(a.anglex5s), f = o(a.angley5s), d = o(a.mad5s), p = o(a.enmoa5s), m = i(a.ggirInvalid5s), g = i(a.ggirNonwear5s), y = s(a.countsX), b = s(a.countsY), w = s(a.countsZ), E = s(a.countsVm), v = o(a.zcx60s), A = o(a.zcy60s), S = o(a.zcz60s), M = o(a.mimsUnit), k = o(a.mimsUnitX), x = o(a.mimsUnitY), T = o(a.mimsUnitZ), z = i(a.preschoolWristRfClasses), P = (U = a.lstmFeatures30s) instanceof Float32Array ? U : U ? new Float32Array(U) : /* @__PURE__ */ new Float32Array(0);
		var U;
		return h({
			enmo5s: c,
			anglez5s: u,
			...
			tzJump: a.tzJump,
			dstTransitions: a.dst?.transitions ?? [],
			dstTimezone: a.dst?.timezone ?? null,
			ggir: a.ggir ?? null,
