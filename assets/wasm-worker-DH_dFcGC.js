...
function Se(e, n = "computeMimsUnit") {
	...
	const m = i("mimsOrientationYAngle");
	m && (o.mimsOrientationYAngle = m);
	const f = i("mimsOrientationZAngle");
	return f && (o.mimsOrientationZAngle = f), o;
}
function ve(e) {
...
"undefined" != typeof self && "undefined" == typeof window && (function() {
	...
	async runScoredVariantBatch(e) {
		...
		if (0 === u) {
			...
			const s = function(e) {
				let n;
				if ("variant" in e) {
					const { variant: a, timestamps: i, activityCounts: o, sleepScores: s, analysisDate: c, epochLengthSeconds: l, hdczaWindow: u, diary: d, onsetMinConsecutiveSleep: p, offsetMinConsecutiveMinutes: m, choiNonwear: f, eventMarkerTimestamps: y, actiwareRestWindow: _ } = e, g = a.config.rescoring === S && (r = S) === S ? { preset: r } : void 0;
					n = {
						timestamps: i,
						activityCounts: o,
						sleepScores: s,
	...
	async processRawXyz(e, n, t, r, a, i) {
		const o = (await be()).processRawXyz(e, n, t, r, a, i ?? void 0), s = "object" == typeof o && null !== o ? o : null, c = s ? ve(s.enmo5s) : null, l = s ? ve(s.anglez5s) : null, u = s ? ve(s.countsX) : null, d = s ? ve(s.countsY) : null, p = s ? ve(s.countsZ) : null, m = s ? ve(s.countsVm) : null;
		if (!(c && l && u && d && p && m)) throw new Error(`processRawXyz: unexpected WASM return shape — got ${JSON.stringify(o)}`);
	...
	}((await be()).getComputeCapabilitiesV1(), "4f9fe1d58d8b5880b84be130c1a793a5972db7979bf19b6842737954019cad7d"),
