...
function U(e, t) {
	...
	return {
		scale: O(n.scale, t ? 1 : 0),
		offset: O(n.offset, 0),
		temperatureOffset: O(n.temperatureOffset, 0),
...
function x(e) {
	...
	return {
		...r,
		disposition: n,
		observed: "observed" in t ? U(t.observed, !0) : r,
		applied: "applied" in t ? U(t.applied, !0) : r
	};
}
...
function D() {
	return z || (z = (async () => {
		const e = await import("./actours-DUK_R_oO.js");
...
"undefined" != typeof self && "undefined" == typeof window && (function() {
	...
	async scoreSadeh(e, t) {
		const n = await D(), r = new Uint8Array(n.scoreSadeh(e, t));
		return g(r, [r.buffer]);
	},
	async scoreColeKripke(e, t) {
		const n = await D(), r = new Uint8Array(n.scoreColeKripke(e, t));
		return g(r, [r.buffer]);
	},
	async detectNonwear(e) {
		const t = await D(), n = new Uint8Array(t.detectNonwear(e));
		return g(n, [n.buffer]);
	},
	async detectNonwearChoi2011(e, t = 60) {
		const n = await D(), r = new Uint8Array("function" == typeof n.detectNonwearChoi2011Epoch ? n.detectNonwearChoi2011Epoch(e, t) : n.detectNonwearChoi2011(e));
		return g(r, [r.buffer]);
	},
	...
	async streamParseFinishChunk() {
		...
		return g({
			...
			rawRetentionDegraded: O.rawRetentionDegraded ?? !1,
			canonicalPassDegraded: O.canonicalPassDegraded ?? !1,
			canonicalPassReason: O.canonicalPassReason ?? null
		}, [
			t.buffer,
			n.buffer,
			r.buffer,
	...
	async neishabouriCounts(e, t, n, r, a) {
		const o = (await D()).neishabouriCounts(e, t, n, r, a), s = "object" == typeof o && null !== o ? o : null, i = s ? G(s.x) : null, c = s ? G(s.y) : null, u = s ? G(s.z) : null, l = s ? G(s.vm) : null;
	...
	async zeroCrossingCounts(e, t, n, r, a) {
		const o = (await D()).zeroCrossingCounts(e, t, n, r, a), s = "object" == typeof o && null !== o ? o : null, i = s ? G(s.zcx) : null, c = s ? G(s.zcy) : null, u = s ? G(s.zcz) : null;
	...
	async computeMimsUnit(e, t, n, r, a = {}) {
		...
		const s = $(o.computeMimsUnit(e, t, n, r, a), "computeMimsUnit");
		return g(s, [
			s.mimsUnit.buffer,
			s.mimsUnitX?.buffer,
			s.mimsUnitY?.buffer,
	...
	async computeMimsUnitDataframe(e, t, n, r, a = {}) {
		...
		const s = $(o.computeMimsUnitDataframe(e, t, n, r, a), "computeMimsUnitDataframe");
		return g(s, [
			s.mimsUnit.buffer,
			s.mimsUnitX?.buffer,
			s.mimsUnitY?.buffer,
	...
	async classifyActimetricPreschoolWristRf(e, t, n, r) {
		...
		const s = function(e, t = "classifyActimetricPreschoolWristRf") {
			...
			const r = "object" == typeof e && null !== e ? e : null, a = r ? j(r.classes) ?? j(r.activityClasses) ?? j(r.predictions) ?? j(r.activity) : null;
	...
	async scoreConsensus(e, t) {
		const n = await D(), r = JSON.stringify({
			strategy: e,
	...
	async computeSleepMetrics(e, t, n) {
		const r = (await D()).computeSleepMetrics(e, t, n);
	...
	epochRawData: async (e, t, n, r, a) => J((await D()).epochRawData(e, t, n, r, a), "epochRawData"),
	async epochWithBandpass(e, t, n) {
		const r = (await D()).epochWithBandpass(e, t, n), a = "object" == typeof r && null !== r ? r : null, o = G(a?.timestamps), s = G(a?.counts);
	...
	async processRawXyz(e, t, n, r, a, o) {
		const s = (await D()).processRawXyz(e, t, n, r, a, o ?? void 0), i = "object" == typeof s && null !== s ? s : null, c = i ? G(i.enmo5s) : null, u = i ? G(i.anglez5s) : null, l = i ? G(i.countsX) : null, f = i ? G(i.countsY) : null, p = i ? G(i.countsZ) : null, m = i ? G(i.countsVm) : null;
		if (!(c && u && l && f && p && m)) throw new Error(`processRawXyz: unexpected WASM return shape — got ${JSON.stringify(s)}`);
		const y = (e) => G(e) ?? new Float64Array(0), d = i ? y(i.anglex5s) : new Float64Array(0), w = i ? y(i.angley5s) : new Float64Array(0), b = i ? y(i.mad5s) : new Float64Array(0), h = i ? y(i.enmoa5s) : new Float64Array(0);
		return g({
			enmo5s: c,
			anglez5s: u,
			anglex5s: d,
	...
	async processRawXyzImputed(e, t, n, r, a, o, s = 60) {
		const i = await D(), c = "function" == typeof i.processRawXyzImputedWithEpoch ? i.processRawXyzImputedWithEpoch(e, t, n, r, a, o ?? void 0, s) : i.processRawXyzImputed(e, t, n, r, a, o ?? void 0), u = "object" == typeof c && null !== c ? c : null, l = u ? G(u.enmo5s) : null, f = u ? G(u.anglez5s) : null, p = u ? G(u.countsX) : null, m = u ? G(u.countsY) : null, y = u ? G(u.countsZ) : null, d = u ? G(u.countsVm) : null;
		if (!(l && f && p && m && y && d)) throw new Error(`processRawXyzImputed: unexpected WASM return shape — got ${JSON.stringify(c)}`);
		const w = (e) => G(e) ?? new Float64Array(0), b = u ? w(u.anglex5s) : new Float64Array(0), h = u ? w(u.angley5s) : new Float64Array(0), A = u ? w(u.mad5s) : new Float64Array(0), S = u ? w(u.enmoa5s) : new Float64Array(0);
		return g({
			enmo5s: l,
			anglez5s: f,
			anglex5s: b,
	...
	async detectDetachFromAccelerationG(e, t) {
		const n = await D(), r = new Uint8Array(n.detectDetachFromAccelerationG(e, t));
		return g(r, [r.buffer]);
	},
	...
	}((await D()).detectHdcza(e, t, n ?? null, r ?? null)),
	...
	getComputeIdentity: async () => function(e, t) {
		...
		if (!(Array.isArray(n.semanticProfiles) ? n.semanticProfiles : []).includes(k)) throw new Error(`Actours capability does not provide required semantic profile ${k}`);
	...
	}((await D()).getComputeCapabilitiesV1(), "905681f2968f8c38d7845499bef12b41cea2b797a5444fca354b1a2c66158bce"),
	runGgirFromEpoch: async (e, t, n, r, a) => (await D()).runGgirFromEpoch({
		anglez: e,
		enmo: t,
		sampleRateHz: n,
		startTsEpochSec: r,
	...
	async readGgirMeta(e) {
		...
		const n = t.readGgirMeta(e), r = "object" == typeof n && null !== n ? n : null, a = r ? G(r.timestampsMs) : null, o = r ? G(r.enmo5s) : null, s = r ? G(r.anglez5s) : null, i = r ? j(r.invalidShort) : null, c = r ? j(r.nonwearShort) : null;
	...
	async scoreGgirSib(e, t, n) {
		const r = (await D()).scoreGgirSib(e, t, n);
	...
	async detectGgirHasptVariant(e) {
		const t = function(e, t) {
			...
			const n = e, r = j(n.nomov), a = G(n.rollingMedian);
