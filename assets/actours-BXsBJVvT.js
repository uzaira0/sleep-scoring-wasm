...
function h(n, e, t, _, r, i, o, c, a, l, s, u, w, g, b, f, d, m, h) {
	const p = Ae(n, Me.__wbindgen_malloc, Me.__wbindgen_realloc), y = Pe, v = ke(e, Me.__wbindgen_malloc), k = Pe, A = ye(t, Me.__wbindgen_malloc), x = Pe, R = ke(_, Me.__wbindgen_malloc), S = Pe, C = ye(r, Me.__wbindgen_malloc), F = Pe, M = ve(i, Me.__wbindgen_malloc), P = Pe, U = ye(o, Me.__wbindgen_malloc), I = Pe, D = ve(c, Me.__wbindgen_malloc), W = Pe, z = ye(a, Me.__wbindgen_malloc), B = Pe, O = ke(l, Me.__wbindgen_malloc), G = Pe, j = ye(s, Me.__wbindgen_malloc), N = Pe, E = ke(u, Me.__wbindgen_malloc), T = Pe, V = ye(w, Me.__wbindgen_malloc), L = Pe, X = ke(g, Me.__wbindgen_malloc), q = Pe, H = ye(b, Me.__wbindgen_malloc), Y = Pe, $ = ke(f, Me.__wbindgen_malloc), Z = Pe, K = ye(d, Me.__wbindgen_malloc), J = Pe, Q = ve(m, Me.__wbindgen_malloc), nn = Pe, en = ye(h, Me.__wbindgen_malloc), tn = Pe, _n = Me.computeNightDifficultyTyped(p, y, v, k, A, x, R, S, C, F, M, P, U, I, D, W, z, B, O, G, j, N, E, T, V, L, X, q, H, Y, $, Z, K, J, Q, nn, en, tn);
...
function y(n, e, t, _, r, i, o, c, a, l, s, u, w, g, b, f, d, m, h) {
	const p = Ae(n, Me.__wbindgen_malloc, Me.__wbindgen_realloc), y = Pe, v = ke(e, Me.__wbindgen_malloc), k = Pe, A = ye(t, Me.__wbindgen_malloc), x = Pe, R = ke(_, Me.__wbindgen_malloc), S = Pe, C = ye(r, Me.__wbindgen_malloc), F = Pe, M = ve(i, Me.__wbindgen_malloc), P = Pe, U = ye(o, Me.__wbindgen_malloc), I = Pe, D = ve(c, Me.__wbindgen_malloc), W = Pe, z = ye(a, Me.__wbindgen_malloc), B = Pe, O = ke(l, Me.__wbindgen_malloc), G = Pe, j = ye(s, Me.__wbindgen_malloc), N = Pe, E = ke(u, Me.__wbindgen_malloc), T = Pe, V = ye(w, Me.__wbindgen_malloc), L = Pe, X = ke(g, Me.__wbindgen_malloc), q = Pe, H = ye(b, Me.__wbindgen_malloc), Y = Pe, $ = ke(f, Me.__wbindgen_malloc), Z = Pe, K = ye(d, Me.__wbindgen_malloc), J = Pe, Q = ve(m, Me.__wbindgen_malloc), nn = Pe, en = ye(h, Me.__wbindgen_malloc), tn = Pe, _n = Me.computeNightSignalsTyped(p, y, v, k, A, x, R, S, C, F, M, P, U, I, D, W, z, B, O, G, j, N, E, T, V, L, X, q, H, Y, $, Z, K, J, Q, nn, en, tn);
	if (_n[2]) throw xe(_n[1]);
	return xe(_n[0]);
}
function v(n, e, t) {
...
function cn(n, e, t, _, r, i, o, c, a, l, s, u, w, g, b, f, d, m, h) {
	const p = Ae(n, Me.__wbindgen_malloc, Me.__wbindgen_realloc), y = Pe, v = ke(e, Me.__wbindgen_malloc), k = Pe, A = ye(t, Me.__wbindgen_malloc), x = Pe, R = ke(_, Me.__wbindgen_malloc), S = Pe, C = ye(r, Me.__wbindgen_malloc), F = Pe, M = ve(i, Me.__wbindgen_malloc), P = Pe, U = ye(o, Me.__wbindgen_malloc), I = Pe, D = ve(c, Me.__wbindgen_malloc), W = Pe, z = ye(a, Me.__wbindgen_malloc), B = Pe, O = ke(l, Me.__wbindgen_malloc), G = Pe, j = ye(s, Me.__wbindgen_malloc), N = Pe, E = ke(u, Me.__wbindgen_malloc), T = Pe, V = ye(w, Me.__wbindgen_malloc), L = Pe, X = ke(g, Me.__wbindgen_malloc), q = Pe, H = ye(b, Me.__wbindgen_malloc), Y = Pe, $ = ke(f, Me.__wbindgen_malloc), Z = Pe, K = ye(d, Me.__wbindgen_malloc), J = Pe, Q = ve(m, Me.__wbindgen_malloc), nn = Pe, en = ye(h, Me.__wbindgen_malloc), tn = Pe, _n = Me.placeMarkersTyped(p, y, v, k, A, x, R, S, C, F, M, P, U, I, D, W, z, B, O, G, j, N, E, T, V, L, X, q, H, Y, $, Z, K, J, Q, nn, en, tn);
	if (_n[2]) throw xe(_n[1]);
	return xe(_n[0]);
}
function an(n) {
...
function ge(n, e) {
	return function(n, e) {
		return Ce += e, Ce >= Se && (Re = new TextDecoder("utf-8", {
			ignoreBOM: !0,
			fatal: !0
		}), Re.decode(), Ce = e), Re.decode(me().subarray(n, n + e));
	}(n >>>= 0, e);
}
let be = null;
function fe() {
...
async function De(n) {
	if (void 0 !== Me) return Me;
	void 0 !== n && (Object.getPrototypeOf(n) === Object.prototype ? {module_or_path: n} = n : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), void 0 === n && (n = new URL("/sleep-scoring-wasm/assets/actours_bg-DFAY9f2j.wasm", "" + import.meta.url));
	const e = ee();
